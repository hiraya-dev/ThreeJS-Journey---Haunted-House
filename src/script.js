...
const doorAmbientOcclussionTexture = textureLoader.load('./door/ambientOcclusion.webp')
...
const tick = () =>
{
    ...
    // Smooth flickering effect for the door light
    // Flickering effect for the door light
    if (Math.random() > 0.9) { // Adjust probability to control how often it flickers
        doorLight.intensity = Math.random() * 3 + 2; // Random intensity between 2 and 5
    }
